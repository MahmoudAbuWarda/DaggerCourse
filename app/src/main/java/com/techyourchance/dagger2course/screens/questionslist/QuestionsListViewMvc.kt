...
class QuestionsListViewMvc(private val layoutInflator:LayoutInflater,
    ...
    private val questionsAdapter: QuestionsAdapter
     ...
     val rootView:View = layoutInflator.inflate(R.layout.layout_questions_list,parent,false)
